...
rm -f runAddFilesINTERACTIVE_proof.txt
rm -f runAddFilesINTERACTIVE_proof_error.txt

(root -l -b -q runAddFilesINTERACTIVE.cc > runAddFilesINTERACTIVE_proof.txt) >& runAddFilesINTERACTIVE_proof_error.txt
