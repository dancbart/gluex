...
# User settings
# ----------------------------
INDIR="/.bscratch/data/dbart013/files/pipkslamb/data/fall2018/flatten/"
PATTERN="tree_pipkslamb__B4_M16_M18_FSFlat_05????.root"

# Final merged output:
OUTFINAL="${INDIR}tree_pipkslamb__B4_M16_M18_FSFlat_fa18_pol_ALL.root"
