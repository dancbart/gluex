...
rm -f runFSFlattenINTERACTIVE_proof.txt
rm -f runFSFlattenINTERACTIVE_proof_error.txt

(root -l -b -q runDSelectorINTERACTIVE.cc > runFSFlattenINTERACTIVE_proof.txt) >& runFSFlattenINTERACTIVE_proof_error.txt
