...
void f1_flat_bx2_analysis() {
   ...
   // ********** DEFINITIONS **********
    ...
    voigtian->SetParameter(0, fitCombined->GetParameter("voigtian_sigma")); //
    voigtian->SetParameter(1, fitCombined->GetParameter("voigtian_lg")); //
    voigtian->SetParameter(2, fitCombined->GetParameter("voigtian_r")); //
