...
def cosTheta_plots(hist, pdf_path):
    ...
    h_acc.SetLineColor(ROOT.kBlue - 3)
    h_acc.SetFillColorAlpha(ROOT.kBlue, 0.30)
...
def MKpi_plots(hist, pdf_path):
    ...
    h_acc_MC = h_acc.Clone("h_MKpi_acc")
    h_acc_MC.SetLineColor(ROOT.kBlue - 3)
    h_acc_MC.SetFillColorAlpha(ROOT.kBlue, 0.30)
