...
TString FND("skim/tree_pi0eta__B4_M17_M7_DATA_sp17_*_GENERAL_SKIM.root");
...
void plots(bool bggen=false){
  ...
  TH2F* hMetapiVsGJCosTheta = FSModeHistogram::getTH2F(FND,NT,"m101_1","GJCOSTHETA(2;3;B):MASS([eta],[pi0])","(100,0.7,2.7,50,-1.,1.)","CUT(unusedTracks,unusedE,zProton,chi2,cet0103,e8288,photFiducialA,photFiducialB,photFiducialC,photFiducialD,delta,rejectOmega,protMom)*CUTWT(rf,eta,pi0)");
