...
baseDir = "/work/halld/home/dbarton/gluex/KShortPipLambda/sdme/files/"
pols = ["0", "45", "90", "135"]

FND_generalCuts_sp18fa18 = f"{baseDir}tree_pipkslamb__B4_M16_M18_GENERAL_SKIM_K892_sp18fa18_pol_ALL.root"
FND_generalCuts_sp20 = f"{baseDir}tree_pipkslamb__B4_M16_M18_GENERAL_SKIM_K892_sp20_pol_ALL.root"
# hadd above 2 files (separate script)
FND_generalCuts_sp18fa18sp20 = f"{baseDir}tree_pipkslamb__B4_M16_M18_GENERAL_SKIM_K892_sp18fa18sp20_pol_ALL.root"
FND_data_prefix = "tree_pipkslamb__B4_M16_M18_SIGNAL_SKIM_K892_pol_"
FND_bkgnd_prefix = "tree_pipkslamb__B4_M16_M18_SIDEBAND_SKIM_K892_pol_"
...
#     setup()
    # ROOT.FSModeTree.skimTree(FND_sp18fa18, NT, "", FND_generalCuts_sp18fa18, f"{generalCuts}")
    # ROOT.FSModeTree.skimTree(FND_sp20, NT, "", FND_generalCuts_sp20, f"{generalCuts}")

# def skim_K892_data_bkgnd_allPol(FND_data, FND_bkgnd):
#     setup()
#     ROOT.FSModeTree.skimTree(FND_generalCuts_sp18fa18sp20, NT, "", FND_data, signalCuts)
#     ROOT.FSModeTree.skimTree(FND_generalCuts_sp18fa18sp20, NT, "", FND_bkgnd, sidebandWeights)
#     friendTreeContents = [(ROOT.TString("weight"), ROOT.TString(sidebandWeights))]
...
def skim_K892_data_bkgnd_allPol(FND_data, FND_bkgnd, pol):
    ...
    # ROOT.FSCut.defineCut(polCutName, f"abs(PolarizationAngle-({pol}))<0.5")
