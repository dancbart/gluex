// This file made 6/25/2024 using the command: MakeDSelector /lustre19/expphy/cache/halld/gluex_simulations/REQUESTED_MC/dbarton_MC_v1_pipkmks_genr8_2017_01_anaVer50_3837/trees/tree_pipkmks__B4_M16_genr8/tree_pipkmks__B4_M16_genr8_030770.root pipkmks__B4_M16_Tree KKpi_mc_v2
// Following instructions under header "Creating a DSelector" in: https://halldweb.jlab.org/wiki/index.php/DSelector

// THE DSELECTOR MACRO WILL ONLY RUN ON iFarm9 !!!!!. So you have to switch to iFarm9 first!!!
// But iFarm9 can't find the function that initializes the GlueX environment, i.e. 'gxenv'.
// So, you have to source this file first:
// source /group/halld/Software/build_scripts/gluex_env_boot_jlab.csh
// Then run 'gxenv'
// Then you should be able to run the DSelector shell script 'runDSelector.csh' which will create a new .root file built from your source .root files, then place that new '.root' file here in this directory.

#include "DSelector_KKpi_mc_v2.h"

void DSelector_KKpi_mc_v2::Init(TTree *locTree)
{
	...
	dOutputFileName = "KKpi_mc_v2.root"; //"" for none
	dOutputTreeFileName = ""; //"" for none
	dFlatTreeFileName = "pipkmks__B4_M16"; //output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_KKpi_mc_v2::Process(Long64_t locEntry)
{
...
void DSelector_KKpi_mc_v2::Finalize(void)
{
