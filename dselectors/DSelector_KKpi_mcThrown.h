#ifndef DSelector_KKpi_mcThrown_h
#define DSelector_KKpi_mcThrown_h
...
class DSelector_KKpi_mcThrown : public DSelector
{
	public:

		DSelector_KKpi_mcThrown(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_KKpi_mcThrown(){}
	...
	private:
		...
		std::vector<int> locPIDArray;
    	std::vector<int> locIArray;
    	TFile *outputFile;
    	TTree *outputTree;
	...
	ClassDef(DSelector_KKpi_mcThrown, 0);
};

void DSelector_KKpi_mcThrown::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_KKpi_mcThrown_h
