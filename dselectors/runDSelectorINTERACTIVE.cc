...
// TString nameOfTree = "pipkmks__B4_M16_Tree"; // mc tree for Tyler's KKpi analysis
TString nameOfTree = "pi0kplamb__B4_M18_Tree"; // K+ pi0 lambda analysis
TChain *chain = new TChain(nameOfTree);

// Add all files together
chain->Add("/lustre24/expphy/cache/halld/RunPeriod-2018-08/analysis/ver23/tree_pi0kplamb__B4_M18/merged/*.root");
