#include "DSelector_KKpiFlatte.h"

void DSelector_KKpiFlatte::Init(TTree *locTree)
{
...
Bool_t DSelector_KKpiFlatte::Process(Long64_t locEntry)
{
...
void DSelector_KKpiFlatte::Finalize(void)
{
