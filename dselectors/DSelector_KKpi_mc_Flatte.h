#ifndef DSelector_KKpi_mc_Flatte_h
#define DSelector_KKpi_mc_Flatte_h
...
class DSelector_KKpi_mc_Flatte : public DSelector
{
	public:

		DSelector_KKpi_mc_Flatte(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_KKpi_mc_Flatte(){}
	...
	ClassDef(DSelector_KKpi_mc_Flatte, 0);
};

void DSelector_KKpi_mc_Flatte::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_KKpi_mc_Flatte_h
